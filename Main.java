public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("The amount of water each person should save in cubic meters is" + saving + "for" + days + "days");
        System.out.println("The amount of water each person should save in gallons is" + savinggal + "for" + days + "days");
    }
}
